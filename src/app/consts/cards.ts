import { Iai,  ImathArr, Irobotics } from "../models/cards";



  export const aiArr:Array<Iai>= [
  ...
  export const mathArr:Array<ImathArr> = [
  ...
  // 3
  export const roboticsArr:Array<Irobotics> = [
